...
$config = [
    ...
    'common' => [
        ...
        'show_comment_ip' => 'blkadfd',
        'things' => ['hi', 'there', 'how', 'are', 'you']
    ],
    ...
    'defaults' => [
        'UK' => [
            'date_format' => 'j M, Y',
            'show_comment_ip' => 'uk askdlfsdf',
            'things' => ['nope', 'nope', 'nope']
        ],
        'Honda' => [
        ...
        'Admin' => [
            ...
            'show_comment_ip' => 'admin kldkdkdd',
            'things' => ['admin', 'admin', 'admin']
        ],
        'Moderator' => [
